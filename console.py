...
class HBNBCommand(cmd.Cmd):
    ...
    def do_create(self, arg):
        """Usage: create <class>
        Generates a new class instance and print its id.
        """
        argl = parse(arg)
        if len(argl) == 0:
    ...
    def do_show(self, arg):
        ...
        elif "{}.{}".format(argl[0], argl[1]) not in dictoj:
            print("** no instance found **")
        else:
            print(dictoj["{}.{}".format(argl[0], argl[1])])

    def do_destroy(self, arg):
        """Usage: destroy <class> <id> or <class>.destroy(<id>)
        Removes a class instance of a given id."""
        argl = parse(arg)
        dictoj = storage.all()
        if len(argl) == 0:
            print("** class name missing **")
            ...
            print("** instance id missing **")
        elif "{}.{}".format(argl[0], argl[1]) not in dictoj.keys():
            print("** no instance found **")
        else:
            del dictoj["{}.{}".format(argl[0], argl[1])]
            storage.save()
    ...
    def do_update(self, arg):
       ...
       <class>.update(<id>, <dictionary>)
        ...
        if len(argl) == 1:
            print("** instance id missing **")
            return False
        if "{}.{}".format(argl[0], argl[1]) not in dictoj.keys():
            print("** no instance found **")
            return False
        if len(argl) == 2:
        ...
        if len(argl) == 4:
            obj = dictoj["{}.{}".format(argl[0], argl[1])]
