#!/usr/bin/python3
"""Represent unittests for models/base_model.py."""
import os
import models
import unittest
...
class TestBaseModel_instantiation(unittest.TestCase):
    ...
    def test_str_representation(self):
        ...
        base_m = BaseModel()
        base_m.id = "123456"
        base_m.created_at = base_m.updated_at = tim_d
    ...
    def test_instantiation_with_kwargs(self):
        ...
        base_m = BaseModel(id="345", created_at=dt_iso, updated_at=dt_iso)
        self.assertEqual(base_m.id, "345")
        self.assertEqual(base_m.created_at, tim_d)
        self.assertEqual(base_m.updated_at, tim_d)
    ...
    def test_instantiation_with_args_and_kwargs(self):
        tim_d = datetime.today()
        dt_iso = tim_d.isoformat()
        base_m = BaseModel("12", id="345", created_at=dt_iso, updated_at=dt_iso)
        self.assertEqual(base_m.id, "345")
        self.assertEqual(base_m.created_at, tim_d)
        self.assertEqual(base_m.updated_at, tim_d)
